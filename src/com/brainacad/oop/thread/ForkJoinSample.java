...
public class ForkJoinSample {
    ...
    public static void main(String[] args) {
      ...
      //  new ForkJoinPool().invoke(new Calc(0, TOTAL_POINTS));
       Double sum = new ForkJoinPool().invoke(new CalcSum(0, TOTAL_POINTS)); // если нужен результат задачи
    ...
    static class Calc extends RecursiveAction {
        ...
        @Override
        protected void compute() {      // разбтвает задачу на подзадачи
    ...
    static class CalcSum extends RecursiveTask<Double> {        // возвращает результат задачи
